...
const vi = {
  ...
  stock_list_col_volume: 'Khối lượng',
  ...
  detail_tab_company: 'Thông tin',
  detail_tab_business: 'Kinh doanh',
  detail_tab_history: 'Lịch sử',
  detail_tab_data: 'Dữ liệu',
  detail_data_col_date: 'Ngày',
  detail_data_col_open: 'Mở cửa',
  detail_data_col_high: 'Cao',
  detail_data_col_low: 'Thấp',
  detail_data_col_close: 'Đóng cửa',
  detail_data_col_change: 'Biến động',
  detail_data_col_volume: 'Khối lượng',
...
const ja: TranslationMap = {
  ...
  detail_tab_data: 'データ',
  detail_data_col_date: '日付',
  detail_data_col_open: '始値',
  detail_data_col_high: '高値',
  detail_data_col_low: '安値',
  detail_data_col_close: '終値',
  detail_data_col_change: '変動',
  detail_data_col_volume: '出来高',
...
const en: TranslationMap = {
  ...
  detail_tab_company: 'Info',
  detail_tab_business: 'Business',
  detail_tab_history: 'History',
  detail_tab_data: 'Data',
  detail_data_col_date: 'Date',
  detail_data_col_open: 'Open',
  detail_data_col_high: 'High',
  detail_data_col_low: 'Low',
  detail_data_col_close: 'Close',
  detail_data_col_change: 'Change',
  detail_data_col_volume: 'Volume',
